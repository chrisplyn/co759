...
static void usage (char *f)
{
    ...
    fprintf (stderr, "if we want to construct b-graph:'./data_reduction [graph edge file] [b-vector]'\n");
    fprintf (stderr, "if we want to convert a matching in b-graph back to b-matching:'./data_reduction [graph edge file] [b-vector][matching file] '\n");
