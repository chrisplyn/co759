...
SCIP_Bool ghc_tree(
   GRAPH *gr,                            /**< underlying graph */
   SCIP_Bool** cuts,                     /**< array to store the incidence vector of the node bipartition corresponding to 
                                          *   cuts in the graph of capacity <= 2 - minviol */
   int* ncuts,                           /**< pointer to store number of found cuts */
   double minviol                        /**< minimum violation of corresponding subtour elimination constraint  */
   )
{
